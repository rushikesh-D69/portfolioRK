          ...
          {researchItems.map(
            ({ title, org, period, description, tags, kind, href, paperHref, image, logos }) => (
              <StaggerItem key={title}>
                <article className="surface-elevated rounded-2xl overflow-hidden flex flex-col border border-[rgba(255,255,255,0.06)] hover:border-[rgba(59,130,246,0.18)] transition-colors duration-300">
                  {image && (
                  ...
                  <div className="p-5 sm:p-6 flex flex-col flex-1">
                    ...
                    <h3 className="text-white font-bold text-base sm:text-lg tracking-tight leading-snug mb-2 line-clamp-3">
                      {title}
                    </h3>
